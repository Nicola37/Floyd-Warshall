...
//The main method.
int main(){
  //Create and take in values for the number of nodes and edges
  //in the graph, and how many queries will be made.
  int nodes;
  int edges;
  int queries;
  cin >> nodes;
  ...
  //D stores the cost of getting from one node to another.
